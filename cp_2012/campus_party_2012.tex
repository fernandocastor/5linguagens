...
\begin{itemize}
\item Alguém já fez parte do trabalho\vspace{0.3cm}
...
% Perl é mais usada que Ruby e JavaScript? Difícil de acreditar também. 
\end{frame}
...
\vspace{0.2cm}
\begin{center}
\LARGE{Problema do ranking da TIOBE:}\\[0.2cm]
\Large{não menciona diretamente \tred{\textbf{código}} escrito nas linguagens ou \tred{\textbf{número de repositórios ou}} \tred{\textbf{projetos}} que usam certas linguagens.}
\\[0.3cm]
